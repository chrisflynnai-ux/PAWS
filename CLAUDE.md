...
| Role | Model | Tasks |
|------|-------|-------|
| Orchestrator | Claude Opus/Sonnet | Doctrine, schema, architecture, review |
...
.claude/          ← Claude Code config and schemas
...
## Locked Decisions
1. Claude is orchestrator for all refactors
...
7. No OpenClaw dependency — Claude Code is the harness
